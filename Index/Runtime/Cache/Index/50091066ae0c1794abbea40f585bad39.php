...
<ul class="thumbnails">
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/apple.png"/></a></li>
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/android.png"/></a></li>
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/alarm.png"/></a></li>
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/appstore.png"/></a></li>

<li class="col-lg-6"><a class="thumbnail" href="#"><img src="image/apple.png"/></a></li>
<li class="col-lg-6"><a class="thumbnail" href="#"><img src="image/android.png"/></a></li>
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/alarm.png"/></a></li>
<li class="col-lg-3"><a class="thumbnail" href="#"><img src="image/appstore.png"/></a></li>
</ul>
</div>
...
<!--content-->
<div class="container">
<h1 class="page-header">异点文化<small>简单可依赖</small></h1></h1>
...
<div class="col-lg-4"> <!--浏览器默认是12个宽度 要占用3个列 就把12除以3得4 及col-lg-4-->
<h2 class="page-header">区域一</h2>
<p>团支书，团委老师部分需要学生代写8、思想汇报（至少10份，加封面）思想汇报内容要真实，要联系自己的思想、工作、学习、生活实际。三、特殊说明：  1、特别重要的材料有  团组织推荐表、培养考察登记表、群众调查</p>
</div>

<div class="col-lg-4">
<h2 class="page-header">区域二</h2>
<p>填写基本要求：所有材料，都应使用存档材料要求的笔及墨水填写，如钢笔、水性笔，但严禁使用纯蓝墨水及园珠笔填写相关内
二、必要材料及要求：（具体参考详细文档）</p>
</div>

<div class="col-lg-4">
<h2 class="page-header">区域三</h2>
<p>党校结业证书至少要求有党校初级班结业证4、自传（1份，加封面）明材料。</p>
...
<div class="col-md-6">
<p>函调：政审调查证明材料（镰刀锤子公章）。主要是父母及配偶的政审调查证明材料。</p>
</div>
</div>
</div>
