...
<div class="container">
  ...
  <?php $__FOR_START_19953__=1;$__FOR_END_19953__=$pageCount+1;for($i=$__FOR_START_19953__;$i < $__FOR_END_19953__;$i+=1){ ?><li><a href="<?php echo U('Index/Index/blog',array('p' => $i));?>"><?php echo ($i); ?></a></li><?php } ?>
  </ul>
  </div>
