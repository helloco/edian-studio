							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Admin/uploadFame');?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> toast </label>

										<div class="col-sm-9">
											<input type="text" name="fameName" id="form-field-1" placeholder="toast" class="col-xs-10 col-sm-5">
										</div>
									</div>
