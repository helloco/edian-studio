						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Admin/upload');?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 作品简介</label>

										<div class="col-sm-9">
											<input type="text" name="introduce" id="form-field-1" placeholder="作品简介" class="col-xs-10 col-sm-5">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="birthday" id="form-field-1" placeholder="作品发布日期 " class="col-xs-10 col-sm-5">
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 所在地址 </label>

										<div class="col-sm-9">
											<input type="text" name="downloadSrc" id="form-field-1" placeholder="作品下载地址/网站连接" class="col-xs-10 col-sm-5">
										</div>
									</div>
