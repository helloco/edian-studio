...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Edian Studio | Login</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Edian</span>
									<span class="white">Studio</span>
								</h1>
								<h4 class="blue">&copy; 湖工大在线</h4>
							</div>
										...
										<div class="widget-main">
											...
											<form action="<?php echo U('checkLogin');?>" method="post">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Password" name="adminPwd"/>
															<i class="icon-lock"></i>
														</span>
													</label>
													...
													<div class="clearfix">
														<label class="inline">
															<img src='<?php echo U('Admin/Index/verify');?>' />
															<span class="lbl"> 
																<input type="text" class="input-small" name="verify" placeholder="验证码"></span>
														</label>
											...
											<div class="social-or-login center">
												<span class="bigger-110">Recommend</span>
											</div>

											<div class="social-login center">
												<a class="btn btn-primary" href="http://weibo.com/hgdonline" target=_blank title="weibo">
													<i class="icon-weibo"></i>
												</a>

												<a class="btn btn-info" href="http://www.hgdonline.net/" target=_blank title="Home">
													<i class="icon-github-alt"></i>
												</a>

												<a class="btn btn-danger" href="http://wrapbootstrap.com/preview/WB0B30DGR" target=_blank title="Bootstrap ACE admin">
													<i class="icon-vk"></i>
												</a>
											</div>
										</div><!-- /widget-main -->
